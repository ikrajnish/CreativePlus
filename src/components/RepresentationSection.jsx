...
export function RepresentationSection() {
  return (
    <section 
      className="py-16 px-6 sm:px-10 md:px-16 lg:px-24 xl:px-32"
      aria-label="Why Choose Creative Plus Studio"
    >
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center md:text-left">
          <h1 
            className="text-4xl sm:text-5xl font-extrabold text-orange-600 leading-tight mb-6"
            itemProp="headline"
          >
            WHY CHOOSE US?
          </h1>
        ...
        <div className="space-y-6" itemScope itemType="https://schema.org/ItemList">
          {[
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-800" itemProp="name">
                  {item.title}
                </h3>
